...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	ParticleSystemManager* PSM = new ParticleSystemManager();

	PSM->CreateEmitter(pd3dDevice, 60, "particle.jpg", D3DXVECTOR3(10.0f, 5.0f, 0.0f), D3DCOLOR_XRGB(255,0,0));
...
bool InitWindow(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName = L"DirectX9Particles";    // name of menu resource 
	wcex.lpszClassName = L"DirectX9Particles";  // name of window class 
	...
	(
		L"DirectX9Particles", // window class to use
		L"DirectX9Particles", // window title
