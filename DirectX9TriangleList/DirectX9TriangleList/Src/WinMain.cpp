...
HRESULT SetupVertexBuffer()
{
	...
	{
		{720.0f, 50.0f, 0.0f, 1.0f, D3DCOLOR_ARGB(0,255,0,0)},
		{650.0f, 400.0f, 0.0f, 1.0f, D3DCOLOR_ARGB(0,255,0,0)},
		{400.0f, 400.0f, 0.0f, 1.0f, D3DCOLOR_ARGB(0,255,0,0)},

		{320.0f, 50.0f, 0.0f, 1.0f, D3DCOLOR_ARGB(0,0,255,0)},
		{250.0f, 400.0f, 0.0f, 1.0f, D3DCOLOR_ARGB(0,0,255,0)},
		{50.0f, 400.0f, 0.0f, 1.0f, D3DCOLOR_ARGB(0,0,255,0)},

		{600.0f, 50.0f, 0.0f, 1.0f, D3DCOLOR_ARGB(0,0,0,255)},
		{550.0f, 100.0f, 0.0f, 1.0f, D3DCOLOR_ARGB(0,0,0,255)},
		{500.0f, 100.0f, 0.0f, 1.0f, D3DCOLOR_ARGB(0,0,0,255)}
	};

	hr = pd3dDevice->CreateVertexBuffer
	(
		9 * sizeof(CUSTOMVERTEX), // size in bytes of the buffer
		0,
